...
public class Example : MonoBehaviour {
	...
	public void NewShape (){
		...
		if (type == 1) {
			...
			s.addKeyframe (60, 90, 0, 0, point1, 3f, 1f, 2 * Mathf.PI, new Rotation[0], col, 1.0f, widthrand, 0, 1.0f, true, true, false, Tweenmode.Linear);
		...
		if (type == 10) {
			...
			float widthrand=Random.Range(0.5f,10f/ amountrand-0.5f);
			//
            ...
            for (int i = 0; i < amountrand; i++) {
				...
				var inst = Instantiate (shape, pos, transform.rotation,transform);
